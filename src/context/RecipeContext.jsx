...
const RecipeContext = ({ children }) => {
  // Initialize data from localStorage or use default recipes
  const [data, setData] = useState(() => {
    try {
      ...
      // If no saved data, return default recipes + featured recipes
      return [...defaultRecipes, ...featuredRecipes];
    } catch (e) {
  ...
  // One-time initialization to add featured recipes if they don't exist
  useEffect(() => {
